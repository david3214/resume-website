<template>
  <v-main>
    ...
    height='250px'/>
    <h1 class="titleText white--text">Privacy Policy</h1>
    <v-row class="my-3 mx-12">
        <v-col justify='start'>
          <h2>Privacy Policy</h2> <p>
            IndieWest built the Finally Free game as
            a Free game. This SERVICE is provided by
            IndieWest at no cost and is intended for
            use as is.
          </p> <p>
            ...
            Finally Free unless otherwise defined in this Privacy
            Policy.
